...
def generate_keys():
    while True: 
        ...
        total_prime_numbers=p_n_handle.generate_prime_upto_n(100) #Put 200 for high ones
...
def encrypt_keys(public_key,flag):
...
def get_keys():
    ...
    public_keys=encrypt_keys(public_keys,0)
    private_keys=encrypt_keys(private_keys,1)
    print(public_keys)
    print(private_keys)
